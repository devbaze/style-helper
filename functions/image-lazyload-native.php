...
if ( ! function_exists( 'get_native_lazyload_tag' ) ) {
  ...
  // Get image
    $image_urls = helper_get_image_lazyload_sizes( $image_id, $args['sizes'] );
    ...
    $styles = '';
    $styles_array = apply_filters( 'helper_lazyload_tag_styles', [], $image_id );
    $styles_array = apply_filters( 'helper_native_lazyload_tag_styles', $styles_array, $image_id );
