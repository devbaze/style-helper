...
// Native lazyload
require_once helper_base_path() . '/functions/image-lazyload-native.php';

// New cleaner vanilla image lazyload tags introduced in 2.3.1
require_once helper_base_path() . '/functions/image-lazyload-vanilla.php';

// Legacy image lazyload backward compatibility
require_once helper_base_path() . '/functions/image-lazyload-legacy.php';
 ...
 * @since  1.11.0
 */
function helper_get_image_lazyload_sizes( $image_id = 0, $sizes = [] ) {
  ...
  if ( 'attachment' !== get_post_type( $image_id ) && apply_filters( 'helper_lazyload_do_post_type_check', true ) ) {
    return false;
  }
  ...
  return $sizes;
} // end function helper_get_image_lazyload_sizes
 ...
 * @since  1.11.0
 */
function helper_get_image_lazyload_dimensions( $image_id = 0, $sizes = [] ) {
  $image_id = intval( $image_id );
...
} // end helper_get_image_lazyload_dimensions
