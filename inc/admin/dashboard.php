 ...
 *
 *  Turn off by using `remove_action( 'wp_dashboard_setup', 'helper_clear_admin_dashboard' )`
 *  Modify with `add_filter( 'helper_clear_admin_dashboard_boxes', 'myprefix_helper_clear_admin_dashboard_boxes' )`
 *
 *  @since 1.7.0
 */
add_action( 'wp_dashboard_setup', 'helper_clear_admin_dashboard', 99 );
function helper_clear_admin_dashboard() {
	$remove_boxes = [
		'normal'	=> [
			'dashboard_right_now',
	...
	$remove_boxes = apply_filters( 'helper_clear_admin_dashboard_boxes', $remove_boxes );
...
} // end helper_clear_admin_dashboard
