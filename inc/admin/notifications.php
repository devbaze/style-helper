 ...
 *
 *  Turn off by using `remove_action( 'admin_init', 'helper_clean_admin_notices' )`
 *
 *  @since  1.7.1
 */
add_action( 'admin_init', 'helper_clean_admin_notices', 999 );
function helper_clean_admin_notices() {
  $remove_notices = [
  ...
  $remove_notices = apply_filters( 'helper_clear_admin_notices', $remove_notices );
...
} // end helper_clean_admin_notices
