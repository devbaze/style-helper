 ...
 *  @since  1.10.0
 */
add_filter( 'site_status_tests', 'helper_remove_status_tests' );
function helper_remove_status_tests( $tests ) {
  ...
  return $tests;
} // end helper_remove_status_tests
 ...
 *  @since  1.10.0
 */
add_filter( 'debug_information', 'helper_remove_debug_information' );
function helper_remove_debug_information( $debug_info ) {
  ...
  return $debug_info;
} // end helper_remove_debug_information
